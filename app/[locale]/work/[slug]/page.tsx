      ...
      <section className="pt-24 lg:pt-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="flex flex-col gap-6 mb-12">
            ...
            <h1 className="font-serif text-h1 font-light tracking-tight max-w-5xl">
          ...
          >
            <div className="absolute inset-0 flex items-end p-8 lg:p-12">
              <h2 className="font-serif text-[clamp(2rem,5vw,4.5rem)] text-white font-light tracking-tight">
                {project.title}
              </h2>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4">
            ...
            <ul className="space-y-1 text-[var(--text)] text-[1rem]">
              {project.services.map((s) => (
                <li key={s} className="font-serif text-[1.125rem] font-light">
                  — {s}
                </li>
              ))}
            </ul>
            ...
            <div className="col-span-12 lg:col-span-7 lg:col-start-6">
              ...
              <div className="grid grid-cols-3 gap-6 lg:gap-10">
                {project.results.map((r, i) => (
                  <div key={i}>
                    <div className="font-serif text-[clamp(2rem,5vw,3.5rem)] font-light tracking-tight leading-none text-[var(--accent)]">
                      {r.value}
                    </div>
  ...
  return (
    <div className="grid-12 gap-y-6 border-t border-[var(--stroke)] pt-10 lg:pt-16">
      ...
      <div className="col-span-12 lg:col-span-8 lg:col-start-5">
        <p className="font-serif text-[1.5rem] lg:text-[1.875rem] font-light leading-[1.35] tracking-tight text-[var(--text)]">
          {body}
        </p>
      </div>
    </div>
